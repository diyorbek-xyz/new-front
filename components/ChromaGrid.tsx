		...
		<div
			...
			{data.map((c, i) => (
				<article
					...
					className='group relative flex w-[300px] cursor-pointer flex-col border-2 bg-contain! overflow-hidden rounded-2xl border-(--card-border) transition-colors duration-300'
					style={
						{
					...
					/>
					<div className='relative z-10 box-border  flex-1 p-2.5'>
