...
export default function Logo({ size = 36, className }: Readonly<{ size?: number; className?: string }>) {
	return (
		<svg className={cn(className)} width={size} height={size} aria-label='logomark' viewBox='0 0 450 450' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g data-name='bg'>
				<g opacity='0.7'>
			...
			<g data-name='eye-open'>
				...
				<animate attributeName='display' values='inline;none;inline' keyTimes='0;0.93;1' dur='5s' repeatCount='indefinite' />
			</g>
			<g data-name='eye-close' stroke='black' strokeWidth='12' strokeLinecap='round' style={{ display: 'none' }}>
				...
				<animate attributeName='display' values='none;inline;none' keyTimes='0;0.93;1' dur='5s' repeatCount='indefinite' />
			</g>
			<defs>
				<radialGradient id='daisy_disc_gradient' cx='0' cy='0' r='1' gradientUnits='userSpaceOnUse' gradientTransform='translate(40.0037 40.0027) rotate(45) scale(522.888 522.888)'>
