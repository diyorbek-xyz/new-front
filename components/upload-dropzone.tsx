...
export function UploadDropzone({ id: _id, accept, description, changeFile }: UploadDropzoneProps) {
	const id = useId();
	...
	return (
		<div
			...
			<label
				{...getRootProps()}
				className={cn('dark:bg-input/10 hover:bg-accent dark:hover:bg-accent/40 flex w-full min-w-72 cursor-pointer flex-col items-center justify-center rounded-lg bg-transparent px-2 py-6 transition-colors', {
