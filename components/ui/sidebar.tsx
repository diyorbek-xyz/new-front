...
function Sidebar({
	...
	return (
		<div className='group peer relative text-sidebar-foreground hidden md:block' data-state={state} data-collapsible={state === 'collapsed' ? collapsible : ''} data-variant={variant} data-side={side} data-slot='sidebar'>
			...
			<div
				...
				className={cn(
					'fixed bottom-0 z-10 hidden h-[calc(100%-var(--navbar-height))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
